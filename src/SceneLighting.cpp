    ...
    : lightingAttachment(
          ...
          [](SceneLightData &lightData) {
              ...
              const std::vector<PointLightSource> vec = {
                  PointLightSource{glm::vec4{0.2, 0.8, 0.7, 0.0},
                                   glm::vec4{coord1, 3.0, coord2, 0.0}, 1.0f,
                                   5},
                  PointLightSource{glm::vec4{0.5, 0.15, 0.3, .0},
                                   glm::vec4{2.0, coord1, coord2, 0.0}, 0.35f,
                                   5},
                  PointLightSource{glm::vec4{0.35, 0.25, 0.9, 0.0},
              ...
              DirectionalLightSource dirLight{glm::vec4{1.0, 2.0, -0.5, 0.0},
                                              glm::vec4{0.0, 0.9, 0.65, 0.0}};

              memcpy(&lightData.dirLight, &dirLight,
                     sizeof(DirectionalLightSource));
          },
