...
class Pipeline {
  public:
    ...
    void updateUniformStaticLightingBuffers() const; //TODO: this will be more needed when the lighting becomes dynamic
  ...
  private:
    ...
    const size_t numSimpleLightSources;
    ...
    void createUniformSimpleLightingBuffers();
