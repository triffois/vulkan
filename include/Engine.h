...
private:
    ...
    void initVulkan() {
        appInstance = AppInstance{}; //to be explicit;
    ...
    void cleanup() {
        ...
        vkDestroySurfaceKHR(*appInstance.getInstance(), surface, nullptr); //TODO: remove this in favor of app cleanup

        // if (enableValidationLayers) {
        //     DestroyDebugUtilsMessengerEXT(instance, debugMessenger, nullptr);
        // }
        // vkDestroyInstance(*appInstance.getInstance(), nullptr); //TODO: remove this in favor of app cleanup
    ...
    void createSurface() {
        if (glfwCreateWindowSurface(*appInstance.getInstance(), window, nullptr, &surface) != VK_SUCCESS) {
    ...
    void pickPhysicalDevice() {
        ...
        vkEnumeratePhysicalDevices(*appInstance.getInstance(), &deviceCount, devices.data());
    ...
    void createLogicalDevice() {
        ...
        appInstance.setAppDevice(&device);
    }
    ...
    void transitionDepthImageLayout(VkImageLayout fromLayout, VkImageLayout toLayout, VkImage &depthImage, VkCommandBuffer &bufferToRecordOn)
    {
    ...
    void transitionSwapchainImageLayout(VkImageLayout fromLayout, VkImageLayout toLayout, uint32_t swapchainIdx, VkCommandBuffer &bufferToRecordOn)
    {
        VkImageMemoryBarrier imageBarrier{};
        imageBarrier.sType = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER;
        imageBarrier.oldLayout = fromLayout;
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        rInfo.pColorAttachments = &colorAttachment;
        rInfo.pDepthAttachment = &depthAttachment;
        rInfo.viewMask = 0;
        rInfo.layerCount = 1;
        rInfo.flags = 0;
        rInfo.pNext = nullptr;
